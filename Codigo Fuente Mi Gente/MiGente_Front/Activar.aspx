<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Activar.aspx.cs" Inherits="MiGente_Front.Activar" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-12 login-container">
                    <div class="login-card shadow-lg">
                        <h4 style="color:red">Activación de Cuenta</h4>
                        <hr />
                        <div class="">
                        ...
                        <input runat="server" type="text" id="txtEmail" disabled="disabled" class="form-control" placeholder="Correo electrónico"/>
                    </div>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary btn-block" onserverclick="Unnamed_ServerClick"  runat="server" >Crear contraseña</button>
                    </div>
