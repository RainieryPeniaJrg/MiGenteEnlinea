...
public partial class Contratista
{
    ...
    public virtual ICollection<ContratistasFoto> ContratistasFotos { get; set; } = new List<ContratistasFoto>();

    [InverseProperty("Contratista")]
    public virtual ICollection<ContratistasServicio> ContratistasServicios { get; set; } = new List<ContratistasServicio>();
}
